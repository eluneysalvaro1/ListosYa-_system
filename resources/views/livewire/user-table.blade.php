                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-200">
                                ...
                                <td>
                                    <div class="inline-flex">
                                        ...
                                        <button
                                        class=" float-right block focus:outline-none text-white  bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-red-900 "
                                        type="button"> <a href="#">Eliminar</a>
                                    </button>
