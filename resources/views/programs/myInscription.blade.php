            ...
            @forelse ($programs as $program)
                    ...
                    <div class=" m-5 flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                        ...
                        <div class=" w-full flex flex-col justify-between p-4 leading-normal">
                            ...
                            <a href="{{route('programs.downloadContract', $program->user_id)}}" id="{{$program->program_id}}" class="w-full text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                Descargar contrato voluntario
                            </a>
