...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <div id="alert-2" style="margin: 2rem 6rem" class="flex p-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert">
                <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5 text-red-700 dark:text-red-800" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                <span class="sr-only">Información</span>
                <div class="ml-3 text-sm font-medium text-red-700 dark:text-red-800" id="dataError">
                    {{ flash()->message }}
                </div>
            ...
            <div id="alert-3" style="margin: 2rem 6rem" class="flex p-4 bg-green-100 rounded-lg dark:bg-green-200" role="alert">
        ...
        @stack('modals')
        <footer class="mt-6 p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
